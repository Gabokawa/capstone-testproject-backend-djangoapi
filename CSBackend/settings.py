...
ALLOWED_HOSTS = [
    'capstone-testproject-backend-djangoapi.onrender.com', 'localhost', '127.0.0.1', '0.0.0.0', '*'
    ]
...
DATABASES = {
    ...
    'default': {
        ...
        'PASSWORD': 'Nacaytunajoshua99',  # Replace with your PostgreSQL password
...
#FOR DEVELOPMENT LANG DAW IDK WHY Y.Y
